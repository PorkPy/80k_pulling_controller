...
def model(j0, j2, j4, j5, \
    ...
    # Load Saved Model
    with open('/home/ur10pc/Desktop/robot_data/pickle/80k_model.pkl','rb') as f:
...
if __name__ == "__main__":
    ...
    model(1.796 ,2.312 ,  -1.573  ,2.673 ,  -0.105 , -4.655  ,-2.002 , -0.846,  0.608  , -0.038 , -0.000  ,0.000  , 0.000   ,0.000  ) #force = 1.297
